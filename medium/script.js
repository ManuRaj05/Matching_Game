...
function updateProgress() {
  const totalPairs = cards.length / 2; // Total pairs
  const matchedPairs = matchedCount / 2; // Matched pairs
  progressElement.textContent = `Matched Pairs: ${matchedPairs} / ${totalPairs}`;
}
...
function resetGame() {
  ...
  progressElement.textContent = 'Matched Pairs: 0 / 10';
  message.textContent = '';
  generateCards();
}
